    ...
    <PageTransition>
      ...
      <section className="pt-28 pb-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-body text-xs tracking-[0.3em] uppercase text-bronze mb-4">Partner Network</p>
          <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-cacao leading-[1.1] max-w-3xl">
            Apply to join the network
          </h1>
          <p className="font-body text-base text-cacao/50 mt-5 leading-relaxed max-w-xl">
      ...
      <section className="pb-20">
        <div className="max-w-xl mx-auto px-6">
          <div className="bg-cream p-6 lg:p-8 rounded-sm">
